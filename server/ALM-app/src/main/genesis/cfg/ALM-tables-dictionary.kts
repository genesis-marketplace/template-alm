...
tables {
  table(name = "FX_TRADE", id = 11_000, audit = details(id = 11_008, sequence = "FT")) {
  ...
  table(name = "ENTITY", id = 11_001, audit = details(id = 11_009, sequence = "EA")) {
  ...
  table(name = "BOOK", id = 11_002, audit = details(id = 11_010, sequence = "BA")) {
  ...
  table(name = "CLIENT", id = 11_003, audit = details(id = 11_011, sequence = "CA")) {
  ...
  table(name = "LOAN_TRADE", id = 11_005, audit = details(id = 11_012, sequence = "LT")) {
    field("CLIENT_NAME", STRING).notNull()
  ...
  table(name = "CD_TRADE", id = 11_006, audit = details(id = 11_013, sequence = "CT")) {
  ...
  table(name = "FX_RATE", id = 11_007) {
    ...
    primaryKey("TARGET_CURRENCY","SOURCE_CURRENCY")
